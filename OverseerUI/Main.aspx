    ...
    <div class="content">
        <div id="tabs" style="width: 100%; height: 100%">
            ...
            <div id="tab_BrowserHistory">
                <iframe id="BrowseHistory" src="BrowseHistory.aspx" style="width: 100%; height: 600px; overflow: hidden"></iframe>
            </div>
            <div id="tab_TextTriggers">
                <iframe id="TextTriggers" src="TextTriggers.aspx" style="width: 100%; height: 600px; overflow: hidden"></iframe>
            </div>
            <div id="tab_ToneTriggers">
                <iframe id="ToneTriggers" src="ToneTriggers.aspx" style="width: 100%; height: 600px; overflow: hidden"></iframe>
            </div>
            <div id="tab_Administration">
                <iframe id="Administration" src="Administration.aspx" style="width: 100%; height: 600px; overflow: hidden"></iframe>
            </div>
        </div>
    </div>
</body>
